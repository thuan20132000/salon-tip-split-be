...
class SalonServiceCategoryModel(models.Model):
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    salon = models.ForeignKey(Salon, on_delete=models.PROTECT, null=True, blank=True)
...
class SalonServiceModel(models.Model):
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True, null=True)
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    category = models.ForeignKey(SalonServiceCategoryModel, on_delete=models.PROTECT, null=True, blank=True)
    salon = models.ForeignKey(Salon, on_delete=models.PROTECT, null=True, blank=True)
    is_active = models.BooleanField(default=True, help_text="Check this box if the service is active")
    def __str__(self):
        return self.name
